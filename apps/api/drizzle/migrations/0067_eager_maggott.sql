...
CREATE INDEX "oauth_access_token_reference_id_idx" ON "oauth_access_token" USING btree ("reference_id");--> statement-breakpoint
...
CREATE INDEX "oauth_consent_reference_id_idx" ON "oauth_consent" USING btree ("reference_id");--> statement-breakpoint
...
CREATE INDEX "oauth_refresh_token_reference_id_idx" ON "oauth_refresh_token" USING btree ("reference_id");